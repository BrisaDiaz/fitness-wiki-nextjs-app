export default function FormInput({ placeholder, type, register, errors }) {
  return (
    <input
      className={' w-full rounded px-2 py-3 border   placeholder-black placeholder-opacity-40 leading-tight focus:outline-none focus:ring-2  focus:ring-opacity-50 appearance-none '.concat(
        errors
