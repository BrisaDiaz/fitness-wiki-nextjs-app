export default function MenuBtn({ isNavOpen, setIsNavOpen }) {
  return (
    <div
      className={'w-10 h-10  rounded-full  cursor-pointer ml-1 mt-1 fixed z-40 flex flex-col  justify-center items-center shadow-md transform  scale-75 transition ease-in-out bg-green-600 '.concat(
