...
export default function WaterIntakeCalculator({ setWaterIntake }) {
  ...
  return (
    <article className="max-w-md mx-auto mt-6 mb-8 ">
      ...
      />
      <div className="flex flex-col sm:flex-row gap-4 px-6 sm:px-10  sm:justify-between  w-full max-w-md  border py-6 shadow-md bg-white rounded">
        <div className="flex items-center justify-center max-w-min gap-2">
          <label
            htmlFor="totalKcals"
            className="text-lg  text-green-700 font-semibold  w-20 sm:w-auto"
          >
            Weight:
          </label>
          <input
