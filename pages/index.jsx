    ...
    <>
      ...
      <section className="custom-container bg-dot-pattern bg-repeat relative full-screen-h ">
        <section className="mx-auto px-1 sm:px-2 pt-10 ">
          ...
          <h2 className="sm:text-center p-2 pb-4 text-md sm:text-2xl sm:leading-8 font-medium self-align-bottom mb-8 sm:mb-12 hove:scale-105 bg-white rounded-full  text-gray-600 max-w-4xl  mx-auto">
