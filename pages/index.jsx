  ...
  return (
    <>
      ...
      <section className="custom-container bg-dot-pattern bg-repeat relative ">
        <section className="mx-auto px-1 sm:px-2 pt-10 sm:pt-16 ">
          ...
          <h2 className="sm:text-center p-2 pb-4 text-md sm:text-2xl sm:leading-10 font-medium self-align-bottom mb-6 sm:mb-16 hove:scale-105 bg-white rounded-full  text-gray-600 max-w-5xl  mx-auto">
